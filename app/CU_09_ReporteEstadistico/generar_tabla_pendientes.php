<?php
/*
  Archivo     : generar_tabla_pendientes.php
...
WHERE
    R.Id_encuesta IS NULL AND E.Id_encuesta = ? AND AL.Id_carrera = ? AND AA.Id_servicio = ? AND PE.Periodo_tipo = ? AND PE.Periodo_año = ?
";
